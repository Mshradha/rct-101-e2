...
import {Button,ModalBody,Modal,Input,Select,Radio,RadioGroup} from "@chakra-ui/react"
...
const AddProduct = () => {
  ...
  return (
    <>
      <Button my={4} data-cy="add-product-button" onClick= {formOpen}>Add New Product</Button>
      <Modal>
        <ModalBody pb={6}>
